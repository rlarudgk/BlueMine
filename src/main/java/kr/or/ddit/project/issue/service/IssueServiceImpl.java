...
public class IssueServiceImpl implements IssueService {
	...
	@Override
	public int removeIssComm(int issCommNo) {
		int rowcnt = issueDAO.deleteIssComm(issCommNo);
		return rowcnt;
	}

	@Override
	public int modifyIssExp(int issNo) {
		int rowcnt = issueDAO.updateIssExp(issNo);
		return rowcnt;
	}

...
public class BootstrapPaginationRender implements PaginationRenderer {
	...
	public String renderPagination(PagingVO<?> pagingVO) {
		String previousPtrn ="<li class='page-item %s'><a class='page-link paging' %s data-page='%d'>이전</a></li>";
		String nextPtrn =    "<li class='page-item %s'><a class='page-link paging' %s data-page='%d'>다음</i></a></li>";
		...
		html.append("<ul class='pagination pagination-sm' style='margin:0px'>");

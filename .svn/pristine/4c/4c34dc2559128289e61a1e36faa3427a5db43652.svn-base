...
<script type="text/javascript">
	...
	function f_TodayWorkHtml(data){
		console.log("데이터 온다 : ",data);
		let workChargerList = data.workChargerList;
		let todayWorkHtml = "";
		for(let i = 0; i<workChargerList.length; i++){
			...
			todayWorkHtml += `
							...
							<div class="float-end mt-n1">
								<img src="\${data.workChargerList[i].memAttPath}" width="32" height="32" class="rounded-circle" alt="Avatar">
							</div>
